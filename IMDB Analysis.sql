...
SELECT COUNT(*) AS movie_rows_count FROM movie;
    
SELECT COUNT(*) AS ratings_rows_count FROM ratings;
    
SELECT COUNT(*) AS genre_rows_count FROM genre;
    
SELECT COUNT(*) AS directors_rows_count FROM director_mapping;
    
SELECT COUNT(*) AS roles_rows_count FROM role_mapping;
    
SELECT COUNT(*) AS names_rows_count FROM names;
...
-- Type your code below:
SELECT COUNT(*) AS title_nulls FROM movie
WHERE title IS NULL;

SELECT COUNT(*) AS year_nulls FROM movie
WHERE year IS NULL;
...
+---------------+-------------------+ */
-- Type your code below:
SELECT year, COUNT(*) AS number_of_movies_released 
FROM movie 
GROUP BY year;

SELECT MONTH(date_published) AS month_number, COUNT(*) AS number_of_movies_released 
FROM movie 
...
SELECT COUNT(*) AS known_for_movie_nulls
FROM names
...
-- Type your code below:
WITH top_prod AS
( SELECT production company, SUM(total_votes) AS vote_counts
